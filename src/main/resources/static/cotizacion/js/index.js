...
function actualizarPlacas() {
  ...
  document.getElementById("mostrarPrecioPlaca").textContent = "S/.";
  document.getElementById("mostrarStockPlaca").textContent = "Stock: ";
  document.getElementById("mostrarPrecioRam").textContent = "S/.";
  document.getElementById("mostrarStockRam").textContent = "Stock: ";
  document.getElementById("mostrarPrecioRam2").textContent = "S/.";
  document.getElementById("mostrarStockRam2").textContent = "Stock: ";

  if (procesadorId !== "") {
    placaSelect.disabled = false;
    var placas = document.querySelectorAll(
      '#selectPlacaId option:not([value=""])'
    );
    placas.forEach(function (option) {
      var dataProcesadores = option
        .getAttribute("data-procesadores")
        .replace(/[\[\]\s]/g, "") // Quita los corchetes y espacios
        .split(","); // Divide por comas
      if (dataProcesadores.includes(procesadorId)) {
...
function actualizarRams() {
  ...
  if (placaId !== "") {
    ...
    var rams1 = document.querySelectorAll(
      '#selectRamId option:not([value=""])'
    );
    rams1.forEach(function (option) {
      var dataPlacas = option
        .getAttribute("data-placas")
        .replace(/[\[\]\s]/g, "") // Quita los corchetes y espacios
        .split(","); // Divide por comas
      if (dataPlacas.includes(placaId)) {
        option.style.display = "block";
      } else {
        option.style.display = "none";
      }
    ...
    var rams2 = document.querySelectorAll(
      '#selectRamId2 option:not([value=""])'
    );
...
document
  .getElementById("selectProcesadorId")
  .addEventListener("change", function () {
    ...
    document.getElementById("mostrarPrecioProcesador").textContent =
      "S/." + precioProcesador;
    var stockProcesador = selectedOption.getAttribute("data-stock");
    if (stockProcesador === null) {
      stockProcesador = "0";
    }
    document.getElementById("mostrarStockProcesador").textContent =
      "Stock: " + stockProcesador;
  });

document
  .getElementById("selectPlacaId")
  .addEventListener("change", function () {
    ...
    document.getElementById("mostrarPrecioPlaca").textContent =
      "S/." + precioPlaca;
    var stockPlaca = selectedOption.getAttribute("data-stock");
    if (stockPlaca === null) {
      stockPlaca = "0";
    }
    document.getElementById("mostrarStockPlaca").textContent =
      "Stock: " + stockPlaca;
  });
...
document.getElementById("selectRamId").addEventListener("change", function () {
  ...
  document.getElementById("mostrarPrecioRam").textContent = "S/." + precioRam;
...
document.getElementById("selectRamId2").addEventListener("change", function () {
  ...
  document.getElementById("mostrarPrecioRam2").textContent = "S/." + precioRam2;
  var stockRam2 = selectedOption.getAttribute("data-stock");
  if (stockRam2 === null) {
    stockRam2 = "0";
  }
  document.getElementById("mostrarStockRam2").textContent =
    "Stock: " + stockRam2;
});

document
  .getElementById("selectAlmacenamientoId")
  .addEventListener("change", function () {
    ...
    document.getElementById("mostrarPrecioAlmacenamiento").textContent =
      "S/." + precioAlmacenamiento;
    var stockAlmacenamiento = selectedOption.getAttribute("data-stock");
    if (stockAlmacenamiento === null) {
      stockAlmacenamiento = "0";
    }
    document.getElementById("mostrarStockAlmacenamiento").textContent =
      "Stock: " + stockAlmacenamiento;
  });

document
  .getElementById("selectTarjetaId")
  .addEventListener("change", function () {
    ...
    document.getElementById("mostrarPrecioTarjeta").textContent =
      "S/." + precioTarjeta;
    var stockTarjeta = selectedOption.getAttribute("data-stock");
    if (stockTarjeta === null) {
      stockTarjeta = "0";
    }
    document.getElementById("mostrarStockTarjeta").textContent =
      "Stock: " + stockTarjeta;
  });

document
  .getElementById("selectFuenteId")
  .addEventListener("change", function () {
    ...
    document.getElementById("mostrarPrecioFuente").textContent =
      "S/." + precioFuente;
    var stockFuente = selectedOption.getAttribute("data-stock");
    if (stockFuente === null) {
      stockFuente = "0";
    }
    document.getElementById("mostrarStockFuente").textContent =
      "Stock: " + stockFuente;
  });

document
  .getElementById("selectCasseId")
  .addEventListener("change", function () {
    ...
    document.getElementById("mostrarPrecioCasse").textContent =
      "S/." + precioCasse;
    var stockCasse = selectedOption.getAttribute("data-stock");
    if (stockCasse === null) {
      stockCasse = "0";
    }
    document.getElementById("mostrarStockCasse").textContent =
      "Stock: " + stockCasse;
  });

document
  .getElementById("selectMonitorId")
  .addEventListener("change", function () {
    ...
    document.getElementById("mostrarPrecioMonitor").textContent =
      "S/." + precioMonitor;
    var stockMonitor = selectedOption.getAttribute("data-stock");
    if (stockMonitor === null) {
      stockMonitor = "0";
    }
    document.getElementById("mostrarStockMonitor").textContent =
      "Stock: " + stockMonitor;
  });

document
  .getElementById("selectRefrigeracionId")
  .addEventListener("change", function () {
    ...
    document.getElementById("mostrarPrecioRefrigeracion").textContent =
      "S/." + precioRefrigeracion;
    var stockRefrigeracion = selectedOption.getAttribute("data-stock");
    if (stockRefrigeracion === null) {
      stockRefrigeracion = "0";
    }
    document.getElementById("mostrarStockRefrigeracion").textContent =
      "Stock: " + stockRefrigeracion;
  });

document
  .getElementById("selectAccesorioId")
  .addEventListener("change", function () {
    ...
    document.getElementById("mostrarPrecioAccesorio").textContent =
      "S/." + precioAccesorio;
    var stockAccesorio = selectedOption.getAttribute("data-stock");
    if (stockAccesorio === null) {
      stockAccesorio = "0";
    }
    document.getElementById("mostrarStockAccesorio").textContent =
      "Stock: " + stockAccesorio;
  });

document
  .getElementById("selectAccesorioId2")
  .addEventListener("change", function () {
    ...
    document.getElementById("mostrarPrecioAccesorio2").textContent =
      "S/." + precioAccesorio2;
    var stockAccesorio2 = selectedOption.getAttribute("data-stock");
    if (stockAccesorio2 === null) {
      stockAccesorio2 = "0";
    }
    document.getElementById("mostrarStockAccesorio2").textContent =
      "Stock: " + stockAccesorio2;
  });

document
  .getElementById("selectAccesorioId3")
  .addEventListener("change", function () {
    ...
    document.getElementById("mostrarPrecioAccesorio3").textContent =
      "S/." + precioAccesorio3;
    var stockAccesorio3 = selectedOption.getAttribute("data-stock");
    if (stockAccesorio3 === null) {
      stockAccesorio3 = "0";
    }
    document.getElementById("mostrarStockAccesorio3").textContent =
      "Stock: " + stockAccesorio3;
  });

document
  .getElementById("selectAccesorioId4")
  .addEventListener("change", function () {
    ...
    document.getElementById("mostrarPrecioAccesorio4").textContent =
      "S/." + precioAccesorio4;
    var stockAccesorio4 = selectedOption.getAttribute("data-stock");
    if (stockAccesorio4 === null) {
      stockAccesorio4 = "0";
    }
    document.getElementById("mostrarStockAccesorio4").textContent =
      "Stock: " + stockAccesorio4;
  });
...
function actualizarTotal() {
  ...
  var precioAlmacenamiento = obtenerPrecioSeleccionado(
    "selectAlmacenamientoId"
  );
  ...
  var total =
    parseFloat(precioProcesador) +
    parseFloat(precioPlaca) +
    parseFloat(precioRam) +
    parseFloat(precioRam2) +
    parseFloat(precioAlmacenamiento) +
    parseFloat(precioTarjeta) +
    parseFloat(precioFuente) +
    parseFloat(precioCasse) +
    parseFloat(precioMonitor) +
    parseFloat(precioRefrigeracion) +
    parseFloat(precioAccesorio) +
    parseFloat(precioAccesorio2) +
    parseFloat(precioAccesorio3) +
    parseFloat(precioAccesorio4);
...
document
  ...
  .addEventListener("change", actualizarTotal);
document
  .getElementById("selectRamId")
  .addEventListener("change", actualizarTotal);
document
  .getElementById("selectRamId2")
  .addEventListener("change", actualizarTotal);
document
  .getElementById("selectAlmacenamientoId")
  .addEventListener("change", actualizarTotal);

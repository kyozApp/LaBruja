...
public class Refrigeracion implements Serializable
{
	...
	public Refrigeracion(Integer refrigeracionId, String nombre, String imagenNombre, String imagenArchivo,
			Integer stock, Double precio, String descripcion, String url, Categoria categoria) {
